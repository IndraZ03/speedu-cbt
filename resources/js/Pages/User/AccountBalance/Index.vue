                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                                <input value="10000" type="radio" class="btn-check" name="options-outlined"
                                    id="primary-outlined-1" autocomplete="off" @click="clickBalance(10000)">
                                <label class="btn btn-outline-primary w-100" for="primary-outlined-1">Rp. 10.000</label>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                                <input value="30000" type="radio" class="btn-check" name="options-outlined"
                                    id="primary-outlined-2" autocomplete="off" @click="clickBalance(30000)">
                                <label class="btn btn-outline-primary w-100" for="primary-outlined-2">Rp. 30.000</label>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                                <input value="50000" type="radio" class="btn-check" name="options-outlined"
                                    id="primary-outlined-3" autocomplete="off" @click="clickBalance(50000)">
                                <label class="btn btn-outline-primary w-100" for="primary-outlined-3">Rp. 50.000</label>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                                <input value="100000" type="radio" class="btn-check" name="options-outlined"
                                    id="primary-outlined-4" autocomplete="off" @click="clickBalance(100000)">
                                <label class="btn btn-outline-primary w-100" for="primary-outlined-4">Rp.
                                    100.000</label>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control form-control-lg"
                                        placeholder="Nominal Top Up" v-model="form.top_up_balance"
                            ...
                            <div class="col-lg-12">
                                <div class="input-group">
                                    <select v-model="form.payment_method"
                                        :class="{ 'is-invalid': errors.payment_method }" class="form-select" required>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td align="center" colspan="4" v-if="!accountBalances.data.length">Data Top Up Saldo
                                        kosong</td>
                                </tr>
                                <tr v-for="(accountBalance, index) in accountBalances.data" :key="index">
                                    ...
                                    <td>
                                        <span class="badge bg-warning"
                                            v-if="accountBalance.transaction_status == 'pending'">Pending</span>
                                        <span class="badge bg-primary"
                                            v-if="accountBalance.transaction_status == 'paid'">Paid</span>
                                        <span class="badge bg-danger"
                                            v-if="accountBalance.transaction_status == 'failed'">Failed</span>
                                        <span class="badge bg-success"
                                            v-if="accountBalance.transaction_status == 'done'">Done</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
