<template>
    ...
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Top Up Saldo</title>
    </Head>
    <!--start page wrapper -->
                        ...
                        <div class="card border-top border-0 border-3 border-primary">
                            <div class="card-header">
                                <div class="d-lg-flex align-items-center">
                                    ...
                                    <div class="ms-auto">
                                        <Link :href="`/user/account-balances/${transaction.id}`"
                                            class="btn btn-primary btn-sm">Kembali</Link>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body p-4">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" v-model="form.rekening_name"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select v-model="form.bank_id" :class="{ 'is-invalid': errors.bank_id }"
                                            class="form-select">
                                            <option value="">[ Pilih ]</option>
                                            <option v-for="(bank, index) in banks" :key="index" :value="bank.id">
                                                {{ bank.bank_name }} - {{ bank.rekening_name }} - {{
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" v-model="form.total_payment"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="file" class="form-control"
                                            ...
                                            :class="{ 'is-invalid': errors.file }" placeholder="file">
...
export default {
    ...
    setup(props) {
        ...
        const submit = () => {
            // send data to server
            Inertia.post(`/user/account-balances/${props.transaction.id}/payment-confirmations`, {
                forceFormData: true,
