            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center">
                        <Link :href="`/user/users/${user.id}/edit`" class="btn btn-primary btn-sm mt-2 mt-lg-0">Ubah
                        Data</Link>
                        <div class="ms-auto">
                        ...
                        <table class="table mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <th>Tipe Member</th>
                                    <td>:</td>
                                    <td>{{ user.member_type == 1 ? 'Member Gratis Try Out' : 'Member Try Out Berbayar'
                                        }}</td>
                                </tr>
                                <tr>
                                    <th>Status Akun</th>
                                ...
                                <tr v-if="user.is_active == 0 && user.student">
                                    ...
                                    <td>:</td>
                                    <td>
                                        <Link :href="`/admin/users/${user.id}/activation-reminder`"
                                            class="btn btn-success btn-sm">Kirim Reminder</Link>
                                    </td>
                                </tr>
                                <tr>
                                    <th colspan="3">&nbsp;</th>
                                ...
                                <tr>
                                    <th>Jenis Kelamin</th>
                                    <td>:</td>
                                    <td>{{ user.student ? (user.student.gender == 'M' ? 'Laki-laki' : 'Perempuan') : '-'
                                        }}</td>
                                </tr>
                                <tr>
                                    <th>Nomor Whatsapp Aktif</th>
                                    <td>:</td>
                                    <td>{{ user.student && user.student.phone_number ? user.student.phone_number : '-'
                                        }}</td>
                                </tr>
                                <tr>
                                    <th>Alamat</th>
                                ...
                                <tr>
                                    <th>Provinsi</th>
                                    <td>:</td>
                                    <td>{{ user.student && user.student.province ? user.student.province.name : '-' }}
                                    </td>
                                </tr>
                                <tr>
                                    <th>Kota</th>
                                ...
                                <tr>
                                    <th>Kecamatan</th>
                                    <td>:</td>
                                    <td>{{ user.student && user.student.district ? user.student.district.name : '-' }}
                                    </td>
                                </tr>
                                <tr>
                                    <th>Desa / Kel</th>
                                    <td>:</td>
                                    <td>{{ user.student && user.student.village ? user.student.village.name : '-' }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr v-for="(member, index) in user.user_member_category" :key="index">
                                    ...
                                    <td>
                                        <span v-if="member.member_categories"
                                ...
                                <tr>
                                    <td align="center" colspan="4" v-if="!user.user_member_category.length">Data Tidak
                                        Tersedia</td>
                                </tr>
                            </tbody>
                        </table>
