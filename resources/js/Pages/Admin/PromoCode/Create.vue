<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'App' }} - Tambah Kode Promo</title>
    </Head>
                    ...
                    <div class="card border-top border-0 border-3 border-primary">
                        <div class="card-header">
                            <div class="d-lg-flex align-items-center">
                                <h5 class="mb-0">Tambah Kode Promo</h5>
                                <div class="ms-auto">
                            ...
                            <form @submit.prevent="submit">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3" v-if="form.discount_type === 'percentage'">
                                        ...
                                        <small class="text-muted">Batasan maksimal potongan untuk diskon persentase</small>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <small class="text-muted">Kosongkan untuk langsung berlaku</small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="submit" class="btn btn-primary" :disabled="isSubmitting">
                                        ...
                                        <span v-else><i class="bx bx-save"></i> Simpan</span>
                                    </button>
                                </div>
                            </form>
                        </div>
...
export default {
    ...
    setup(props) {
        ...
        const submit = () => {
            ...
            Inertia.post('/admin/promo-codes', form, {
                onFinish: () => {
