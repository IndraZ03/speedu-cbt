<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Edit Program</title>
    </Head>
...
export default {
    ...
    setup(props) {
        ...
        const form = reactive({
            ...
            badge_text: props.program.badge_text || '',
            badge_color: props.program.badge_color || 'primary',
            original_price: props.program.original_price,
            promo_price: props.program.promo_price,
            duration: props.program.duration || '',
            alert_text: props.program.alert_text || '',
            alert_color: props.program.alert_color || 'primary',
            features: props.program.features && props.program.features.length ? props.program.features : [''],
            button_text: props.program.button_text || 'Daftar Sekarang',
            button_color: props.program.button_color || 'primary',
            whatsapp_message: props.program.whatsapp_message || '',
            action_type: props.program.action_type || 'whatsapp',
        ...
        const update = () => {
            ...
            Inertia.put(`/admin/programs/${props.program.id}`, submitData, {
                onFinish: () => {
        ...
        return { form, errors, isSubmitting, addFeature, removeFeature, update };
    }
};
</script>
