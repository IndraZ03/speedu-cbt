<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Edit Testimoni</title>
    </Head>
                    ...
                    <form @submit.prevent="update" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="mt-2">
                                    <img v-if="previewUrl" :src="previewUrl" class="rounded" width="80" height="80" style="object-fit: cover;">
                                    <img v-else-if="testimonial.photo" :src="`/storage/upload_files/testimonials/${testimonial.photo}`" class="rounded" width="80" height="80" style="object-fit: cover;">
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
...
export default {
    ...
    setup(props) {
        ...
        const update = () => {
            ...
            Inertia.post(`/admin/testimonials/${props.testimonial.id}`, formData, {
                onFinish: () => {
        ...
        return { form, errors, isSubmitting, previewUrl, handleFileUpload, update };
    }
};
</script>
